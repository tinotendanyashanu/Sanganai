...
export const startingFeatures = [
  ...
  "Find an event around you",
  "Buy a ticket and join the event",
  "See who is attending the event",
  "Go to the event Scan Code and have fun",
];
...
export const insights = [
  ...
  },
  {
    ...
    subtitle:
      "Master the art of event promotion with proven strategies and creative techniques. This article explores innovative marketing tactics, social media trends, and guerrilla marketing methods that can significantly impact event visibility and attendance rates. Discover how storytelling, influencer partnerships, and interactive content can transform your event promotion efforts",
  },
];
...
export const socials = [
  ...
  {
    name: "linkedin",
    url: "https://www.linkedin.com/company/sanganai/",
    icon: "/linkedin.svg",
  },
  {
    name: "instagram",
